        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="font-mono text-[10px] text-muted-foreground uppercase">
              Market Value: <strong className="text-primary">{approxValue === null ? 'Unavailable' : `$${approxValue.toFixed(2)}`}</strong> · Owned Value: <strong className="text-emerald-500">{ownedApproxValue === null ? 'Unavailable' : `$${ownedApproxValue.toFixed(2)}`}</strong>
            </p>
          </div>
        </div>
