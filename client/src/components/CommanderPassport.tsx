              ...
              <div>
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="flex items-center gap-3">
                    <div className="h-14 w-14 border-2 border-border bg-muted overflow-hidden shrink-0">
                      <img
                        src={scryfallArtUrl}
                        ...
                        loading="lazy"
                        onError={(e) => {
                          (e.currentTarget as HTMLImageElement).src = `data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect fill="%231e293b" width="100" height="100"/><text x="50" y="55" font-family="monospace" font-size="12" fill="%23cbd5e1" text-anchor="middle">CMD</text></svg>`;
                        }}
                      />
                    </div>
                    <div>
