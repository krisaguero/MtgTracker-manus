...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground" ref={menuRef}>
      {/* Compact Top Navigation Bar with Left Logo and Mobile Hamburger */}
      <nav className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur-md" aria-label="Main navigation">
        <div className="container flex items-center justify-between py-2.5">
          ...
          {/* Desktop Nav Links */}
          <div className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-[0.12em]">
        ...
        <div
          className={`overflow-hidden transition-all duration-250 ease-[cubic-bezier(0.23,1,0.32,1)] md:hidden border-b border-border bg-card ${
            mobileMenuOpen ? 'max-h-96 opacity-100 py-4' : 'max-h-0 opacity-0 py-0 border-transparent'
          }`}
        >
