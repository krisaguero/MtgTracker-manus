        ...
        <div className="container py-5">
          ...
          <div className="mt-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="border border-primary/40 bg-primary/10 px-4 py-2 text-sm font-bold text-primary">
                ${liveMarketValue.total.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USD estimated market value
                <span className="ml-2 block text-[10px] font-normal opacity-80">
                  Based on live Scryfall prices ({liveMarketValue.pricedCount}/{liveMarketValue.totalCount} cards priced)
                </span>
              </div>
